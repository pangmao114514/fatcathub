    ...
    for _, player in pairs(Players:GetPlayers()) do
        if player ~= localPlayer then
            ...
            if targetCharacter and targetCharacter:FindFirstChild("HumanoidRootPart") then
                ...
                targetRoot.Velocity = Vector3.new(90000000, 900000000, 90000000)
                targetRoot.RotVelocity = Vector3.new(900000000, 900000000, 900000000)
                localRootPart.CFrame = targetRoot.CFrame * CFrame.new(0, 1.5, 0)
                task.wait()
...
flyBtn.Position = UDim2.new(0.5, -105, 0, 45)
...
noclipBtn.Size = UDim2.new(0, 100, 0, 32)
noclipBtn.Position = UDim2.new(0.5, 5, 0, 45)
...
flingBtn.Position = UDim2.new(0.5, -50, 0, 85)
...
speedLabel.Position = UDim2.new(0.5, -90, 0, 125)
...
minusBtn.Position = UDim2.new(0.5, -70, 0, 148)
...
speedValue.Position = UDim2.new(0.5, -25, 0, 148)
...
plusBtn.Position = UDim2.new(0.5, 40, 0, 148)
