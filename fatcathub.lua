            ...
            if targetChar and targetChar:FindFirstChild("HumanoidRootPart") then
                ...
                if targetHumanoid and targetHumanoid.Health > 0 then
                    for i = 1, 60 do
                        ...
                        local yOffset = math.sin(angle * 3) * 1.5
                        
                        localRoot.CFrame = targetRoot.CFrame * CFrame.new(xOffset, yOffset + 1.5, zOffset)
                        task.wait()
                        
                        targetRoot.Velocity = Vector3.new(xOffset * 5000, 3000 + yOffset * 800, zOffset * 5000)
                        targetRoot.RotVelocity = Vector3.new(5000, 5000, 5000)
                        
                        if i % 10 == 0 then
                            localRoot.Velocity = Vector3.new(xOffset * 2000, 2000, zOffset * 2000)
                        end
                    end
                    
                    targetRoot.Velocity = Vector3.new(math.random(-10000, 10000), 6000, math.random(-10000, 10000))
