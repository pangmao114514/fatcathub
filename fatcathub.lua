            ...
            if targetChar and targetChar:FindFirstChild("HumanoidRootPart") then
                ...
                if targetHumanoid and targetHumanoid.Health > 0 then
                    for i = 1, 8 do
                        ...
                        task.wait()
                        targetRoot.Velocity = Vector3.new(99999999, 99999999, 99999999)
                        targetRoot.RotVelocity = Vector3.new(99999999, 99999999, 99999999)
                        localRoot.Velocity = Vector3.new(99999999, 99999999, 99999999)
                        task.wait()
                    end
