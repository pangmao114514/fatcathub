...
local function applyBlurEffect(enabled)
    if enabled then
        pcall(function()
            ...
            blur.Size = 8
            blur.Name = "UIFatCat HUBBlur"
            blur.Parent = game:GetService("Lighting")
        end)
    else
        pcall(function()
            local existingBlur = game:GetService("Lighting"):FindFirstChild("UIFatCat HUBBlur")
...
local skySettings = {
    ["胖猫天空1"] = "http://www.roblox.com/asset/?id=112666167201442",
    ["胖猫天空2"] = "http://www.roblox.com/asset/?id=105006817202266",
    ["动漫猫羽雫天空"] = "http://www.roblox.com/asset/?id=16060333448"
}

local selectedSky = "胖猫天空1"
...
Settings:Button({
    ...
    Callback = function()
        ...
        setclipboard("FatCat HUB V2 设置: " .. game:GetService("HttpService"):JSONEncode(settings))
        playSound()
    end
})
