...
createButton("飞行", generalPage, function() notify("功能", "加载飞行") loadstring(game:HttpGet("https://raw.githubusercontent.com/pangmao114514/fatcathub/main/flysp.lua"))() end)
