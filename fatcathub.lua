...
floatingBtn.ImageColor3 = Color3.fromRGB(80, 80, 80)
...
menuTitle.Size = UDim2.new(1, 0, 0, 34)
...
flyBtn.Size = UDim2.new(0, 80, 0, 32)
flyBtn.Position = UDim2.new(0.5, -85, 0, 44)
...
noclipBtn.Size = UDim2.new(0, 80, 0, 32)
noclipBtn.Position = UDim2.new(0.5, 5, 0, 44)
...
flingBtn.Size = UDim2.new(0, 80, 0, 32)
flingBtn.Position = UDim2.new(0.5, -40, 0, 86)
flingBtn.BackgroundColor3 = Color3.fromRGB(200, 100, 100)
flingBtn.BackgroundTransparency = 0.2
flingBtn.Text = "甩飞"
...
quickBtn.Size = UDim2.new(0, 80, 0, 32)
quickBtn.Position = UDim2.new(0.5, -40, 0, 128)
quickBtn.BackgroundColor3 = Color3.fromRGB(100, 150, 100)
...
speedLabel.Size = UDim2.new(0, 140, 0, 18)
speedLabel.Position = UDim2.new(0.5, -70, 0, 170)
speedLabel.BackgroundTransparency = 1
speedLabel.Text = "速度 " .. Config.FlySpeed
...
minusBtn.Position = UDim2.new(0.5, -45, 0, 188)
...
speedValue.Size = UDim2.new(0, 40, 0, 22)
speedValue.Position = UDim2.new(0.5, -20, 0, 188)
...
plusBtn.Position = UDim2.new(0.5, 20, 0, 188)
...
floatingBtn.MouseButton1Click:Connect(function()
    ...
    if menuOpen then
        menuFrame.Position = UDim2.new(0, -190, 0, 0)
...
flyBtn.MouseButton1Click:Connect(function()
    ...
    if Config.FlyEnabled then
        flyBtn.Text = "飞行 ON"
        flyBtn.BackgroundColor3 = Color3.fromRGB(100, 180, 100)
        floatingBtn.ImageColor3 = Color3.fromRGB(100, 180, 100)
        startFly()
    else
        flyBtn.Text = "飞行 OFF"
        flyBtn.BackgroundColor3 = Color3.fromRGB(70, 130, 200)
...
noclipBtn.MouseButton1Click:Connect(function()
    ...
    if Config.NoclipEnabled then
        ...
        noclipBtn.BackgroundColor3 = Color3.fromRGB(100, 180, 100)
        floatingBtn.ImageColor3 = Color3.fromRGB(100, 180, 100)
        startNoclip()
    else
        noclipBtn.Text = "穿墙 OFF"
