...
local function startFling()
    ...
    local bV = hrp:FindFirstChild("FlingBV") or Instance.new("BodyVelocity")
    bV.Name = "FlingBV"
    bV.Velocity = Vector3.new(4000, 4000, 4000)
    bV.MaxForce = Vector3.new(math.huge, math.huge, math.huge)
    bV.Parent = hrp
    
    local bA = hrp:FindFirstChild("FlingBAV") or Instance.new("BodyAngularVelocity")
    bA.Name = "FlingBAV"
...
createButton("飞行脚本", generalPage, function() notify("反馈", "飞行开启成功") loadstring(game:HttpGet("https://raw.githubusercontent.com/pangmao114514/fatcathub/main/flysp.lua"))() end)
